# -*- coding: utf-8 -*-
"""Narmax_CNN_Consumo Electrico.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1DNKzE2fIiYICed985lcTqnw_hIqM9my-
...
loaded_model.compile(loss='mean_squared_error', optimizer=Adam(learning_rate=2.3045326281192637e-05), metrics = [tf.keras.metrics.MeanSquaredError(),
...
csv_filename = 'Narmax_results_CNN_CE.csv'
csv_path = os.path.join(folder_path, csv_filename)
results_csv.to_csv(csv_path, index=False)

import os
# Ruta de la carpeta que deseas crear
carpeta_destino = '/content/gdrive/MyDrive/Tesis/Datos-ConsumoElectrico/Resultados_Modelos/Narmax_result_cnn'
