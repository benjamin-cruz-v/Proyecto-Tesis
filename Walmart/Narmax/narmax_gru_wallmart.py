# -*- coding: utf-8 -*-
"""Narmax_GRU_Wallmart.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ueE0qTh_vPajgnZl-OCmsfdQsIhUFhyX
...
space = {
    ...
    'optimizer':'adam',
    'neurons': 540,
    'dropout':0.5835013897642799,
    'layers': 2,
    'learning_rate':  2.2134821488619285e-05
}
'''
...
for result in all_results:
  ...
  for time in result['time']:
    k+=1
    nameModel = "GRU_Wallmart" +"_"+str(trial)+"_"+str(k)+ "_"+str(result['params']['epochs'])+"_"+str(result['params']['batch_size'])+"_"+str(result['params']['layers'])+"_"+str(result['params']['neurons'])+"_"+str(round(result['params']['dropout'],2))+"_"+str(result['params']['optimizer'])+"_"+str(result['params']['learning_rate'])
...
results_csv.to_csv('Narmax_results_GRU_Wallmart.csv')
